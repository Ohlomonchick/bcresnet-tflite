...
class BCResNets(nn.Module):
    ...
    def _build_network(self):
        ...
        self.classifier = nn.Sequential(
            nn.Conv2d(
                self.c[-2], self.c[-2], (1, 5), bias=False, groups=self.c[-2], padding=(0, 2)
            ),
    ...
    def forward(self, x):
        ...
        avg_pool_kernel_size = (input_height, input_width)
        x = F.avg_pool2d(x, kernel_size=avg_pool_kernel_size)
